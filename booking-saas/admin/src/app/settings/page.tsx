                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    ...
                    {business.subscription_tier === 'free' && (
                      <p className="text-sm text-orange-600 mt-1">Kræver Starter plan eller højere</p>
                    )}
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      disabled={business.subscription_tier === 'free'}
                      className="sr-only peer"
                    />
                ...
                <div className="mt-6">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b">
                        <td className="py-2 font-mono text-xs">data-locale="kl"</td>
                        <td className="py-2">Skift sprog (da, kl, en)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
